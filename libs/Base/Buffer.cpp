...
Buffer::Buffer(const vkb::Device &device, VmaAllocator allocator, VkCommandPool commandPool, VkBufferUsageFlags usage,
...
void Buffer::destroy(const VkDevice device, VmaAllocator const &allocator) {
